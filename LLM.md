# zen-designer — AI Knowledge Base

**Project**: zen-designer
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen-designer
**HuggingFace**: https://huggingface.co/zenlm/zen-designer
**Last Updated**: 2026-02-27

## Overview

zen-designer is part of the Zen AI model family by Hanzo AI / Zen LM.
